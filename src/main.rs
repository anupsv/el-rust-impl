...
fn main() {
    ...
    if el_circuit.non_signer_pubkeys.len() > 0 {
        ...
        let g1_points: Vec<_> = el_circuit.non_signer_pubkeys
            ...
            .collect();
        let all_operators_circuit_g1_apk = g1_chip.assign_point::<G1Affine>(circuit.main(0), el_circuit.all_operators_circuit_g1_apk);
        ...
        signers_g1_apk = g1_chip.assign_point::<G1Affine>(circuit.main(0), el_circuit.all_operators_circuit_g1_apk);
    }
    ...
    let task_response_digest_bn254_g2 = g2_chip.assign_point::<G2Affine>(circuit.main(0), el_circuit.task_response_digest_bn254_g2);
